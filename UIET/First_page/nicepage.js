!(function (t) {
  ...
  410: function (t, e, n) {
    ...
    i.registerAnimation(n(411)),
      i.registerAnimation(n(414)),
      i.registerAnimation(n(179));
  },
  411: function (t, e, n) {
    "use strict";
    function i(t, e) {
  ...
  9476: function (t, e, n) {
    ...
    function i() {
      return {
        submit: function (t) {
          ...
          if (
            ...
            i =
              ...
              !f.isNumeric(form.attr("redirect-url"))
                ? form.attr("redirect-url")
                : form.attr("redirect-address");
          if (
            "email" === e &&
            !f(form).find('input[name="npspec-referer"]').length
          )
            f(form).append(
        ...
        click: function (t) {
          t.preventDefault(),
            t.stopPropagation(),
            f(this).find(".u-form-send-success").hide(),
            f(this).find(".u-form-send-error").hide();
    ...
    f(function () {
      ...
      f(
        ...
        f(".u-form .u-form-submit a").click(form.click);
    }),
     ...
     * Copyright (c) 2019 Dmitry Semenov; */ !(function (a, factory) {
      ...
      var t = function (template, t, items, e) {
        ...
        var u = function () {
          ...
          zt = function () {
            for (var t in Ft) if (Ft.hasOwnProperty(t)) Rt(t);
          },
              ...
              if (!l && !f) {
                ...
                if (
                  ...
                  I = setInterval(function () {
                    if (!Pt && !ue && !ye && _ === i.currItem.initialZoomLevel)
                      i.updateSize();
                  }, 1e3);
            ...
            var t,
              ...
              i = {
                ...
                panAnimLoop: function () {
                  if (Ft.zoomPan)
                    if (
                      ((Ft.zoomPan.raf = W(i.panAnimLoop)),
                      (i.now = ct()),
              ...
              if (e)
                if (!ce && !le && !Pt) {
                  var i = e,
                    o;
                  if (kn)
                    if ((clearTimeout(kn), (kn = null), Fe(i, Dn)))
          ...
          (n.onGlobalTap = function (i) {
            ...
            if (!S)
              if (i.detail && "mouse" === i.detail.pointerType) {
                ...
                if (C.tapToClose && (e.hasClass(a, "pswp__img") || F(a)))
          ...
          for (e = 0, o = t.length; e < o; e++) {
            ...
            if (el.attributes) {
              ...
              if (u.length) {
                var _, S, id;
                if (!a && F in el)
                  (id = el[F]), (_ = Lt[id].styleAttr), (S = Lt[id].classAttr);
            ...
            vt(f, [h, p, m, v].join(" "), function (e) {
              ...
              switch (e.type) {
                case h:
                  ...
                  break;
                case p:
                  if (P.test(s.tagName) && n.activeElement !== s)
                    e.preventDefault();
                  (w = l - y),
                    (_ = x - C),
              ...
              for (var C = 1; C <= x; C++) {
                ...
                I && !M && (P += " qs-event"),
                  ...
                  (l[+T] ||
                    ...
                    !M &&
                    (P += " qs-disabled"),
                  +v(new Date()) == +T && (P += " qs-current"),
                  +T === m && g && F && (P += " qs-range-start"),
                  +T > m && +T < g && (P += " qs-range-middle"),
                  +T === g && m && F && (P += " qs-range-end"),
                  M && ((P += " qs-empty"), (L = "")),
                  q.push(
                    '<div class="' +
                      P +
                      ...
                      if (i.contains("qs-num")) {
                        ...
                        if (C) {
                          (o.currentYear = _.getFullYear()),
                            ...
                            (o.currentMonthName = P[o.currentMonth]),
                            a(o);
                          for (
                            var S,
